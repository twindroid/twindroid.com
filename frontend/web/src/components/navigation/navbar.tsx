...
export function NavBar() {
  return <nav className="flex bg-bg-100 text-white border-b border-white w-full">
      <div className="flex py-3 md:py-4 justify-between w-full items-center max-w-[1650px] mx-auto">
        <div className="flex gap-x-4">
          <Image
            ...
            alt="logo"
          />
          <a className="hidden sm:block cursor-pointer text-2xl lg:text-3xl my-auto font-bold">
            twindroid.com
          </a>
        </div>
